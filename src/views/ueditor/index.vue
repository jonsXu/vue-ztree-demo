<template>
    <div  class="res-ueditor" >
        <div class="emra-oak">
          ...
          <div class="edui-default edui-util" style="border-bottom:1px solid #ccc;width:210mm">
            <div v-for="(item,i) in doType" :key="i">
                ...
                <div v-show="item =='plugin'"  v-html="emreHtml" class="edui-toolbar" style="display: block"></div>
            ...
            <div class="ueditor-oak" style="width:210mm;min-height:700px; margin:0 auto">
                <div class="ueditor-script-oak" :id="id" style="width: 100%;"  name="content" type="text/plain"></div>
            </div>
        </div>
    </div>
